...
const Search = () => {
    ...
    let addcart = (prodobj) => {
        if (obj.state.token !== "") {
            axios.post("https://blue-shop.onrender.com/addcart", { "uid": obj.state._id, "pid": prodobj._id, "pimg": prodobj.pimg, "price": prodobj.price, "name": prodobj.name, "qty": 1, "desc": prodobj.desc, "cat": prodobj.cat }).then(() => {
                navigate("/cart")
            })
        }
        else {
